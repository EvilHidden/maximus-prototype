...
export function CalendarDayCard({
  ...
  return (
    <button
      ...
      onClick={onClick}
      className={cx(
        "flex min-h-[104px] flex-col items-stretch justify-start rounded-[var(--app-radius-md)] border px-2 py-1.5 text-left align-top transition-colors lg:min-h-[92px] xl:min-h-[104px]",
        isSelected
