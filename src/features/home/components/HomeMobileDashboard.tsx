...
function MobileMetric({
  ...
  return (
    <div className="min-w-0">
      <div className="app-text-overline text-[var(--app-text-soft)]/70">{label}</div>
      <div className={`app-text-value mt-1.5 truncate text-[1.02rem] ${valueToneClassName}`}>{value}</div>
    </div>
  );
}
    ...
    <section className="border-t border-[var(--app-border)]/34 pt-5.5 first:border-t-0 first:pt-0">
      <div className="flex items-start justify-between gap-3">
        <div className="flex items-start gap-2.5">
          <Icon className="mt-0.5 h-4 w-4 shrink-0 text-[var(--app-text-soft)]/88" />
          <div>
            <div className="app-text-strong text-[0.98rem]">{title}</div>
            <div className="mt-1 app-text-caption text-[var(--app-text-soft)]/78">{subtitle}</div>
          </div>
        </div>
        <div className="app-text-overline shrink-0 pt-1.5 text-[var(--app-text-soft)]/62">
          {count} {countLabel}
        </div>
      </div>
...
function MobileAppointmentRow({
  ...
  return (
    <div className="border-b border-[var(--app-border)]/34 py-6 last:border-b-0 last:pb-0 first:pt-0">
  ...
  return (
    <div className="space-y-6.5 md:hidden">
      <div className="space-y-3.5 pb-2.5">
        <div className="flex items-start justify-between gap-3">
          <div>
            <div className="app-text-overline text-[var(--app-text-soft)]/55">Main dashboard</div>
            <div className="app-text-strong mt-1 text-[1rem]">Home</div>
          </div>
          <CountPill count={visibleAppointmentCount + visiblePickupCount} label="items" icon={CalendarDays} tone="default" className="px-2 py-1 opacity-35" />
        </div>

        <div className="grid grid-cols-3 gap-3 border-t border-[var(--app-border)]/12 pt-3">
      ...
      <div className="space-y-2 border-b border-[var(--app-border)]/14 pb-4.5">
        <div className="app-text-overline px-1 text-[var(--app-text-soft)]/42">Locations</div>
